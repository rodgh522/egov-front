import { Configuration, UserManagementApi, TenantControllerApi, BranchControllerApi, GroupControllerApi, PositionControllerApi, CustomerControllerApi, OpportunityControllerApi, PipelineStageControllerApi, LeadControllerApi } from '@/api/generated';
